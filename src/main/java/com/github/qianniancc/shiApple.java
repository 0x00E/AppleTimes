...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"X1X", "X4X", "XXX", Character.valueOf('1'), new ItemStack(Blocks.cobblestone, 1), Character.valueOf('4'), new ItemStack(Items.apple, 1), 
});}
...
static{
block = (Item)(new Qianniancc(1, 0.3F, false));block = ((Qianniancc)block).setUnlocalizedName("ShiApple").setTextureName("shiapple");
block.setMaxStackSize(64);
Item.itemRegistry.addObject(427, "ShiApple", block);
